...
if( file_to_add == "pdf"){ file_icon = '<img src="../../static/convert_docx/file_icons/pdf.png" align="absmiddle" border="0" alt="" />'; }
...
elseif( file_to_add == "doc" || file_to_add == "docx" || file_to_add == "rtf" ){ file_icon = '<img src="../../static/convert_docx/file_icons/doc.png" align="absmiddle" border="0" alt="" />'; }
...
else if( file_to_add == "png" ){ file_icon = '<img src="../../static/convert_docx/file_icons/png.png" align="absmiddle" border="0" alt="" />'; }
else if( file_to_add == "pps" ){ file_icon = '<img src="file_icons/pps.png" align="absmiddle" border="0" alt="" />'; }
else if( file_to_add == "ppt" || file_to_add == "pptx" ){ file_icon = '<img src="../../static/convert_docx/file_icons/ppt.png" align="absmiddle" border="0" alt="" />'; }
else if( file_to_add == "ps" ){ file_icon = '<img src="../file_icons/file_icons/ps.png" align="absmiddle" border="0" alt="" />'; }
		...
		if(this.files.length > 0)
		{
 			...
 			for(var i = 0; i<this.files.length; i++)
			{
				...
				if(typeof this.files[i] != undefined && this.files[i].name != ""){
					added_files_displayer += '<div id="add_fileID'+file_id+'" class="bx_main"> <div class="bx_1">'+fileIcon(file_to_add)+'</div> <div class="bx_2"><span class="fname">'+this.files[i].name.substring(0, 30)+'</span> <br/> <span class="fsize">'+fileSizeformat(fileSize)+'</span>  </div><div class="bx_3" id="bx_3_'+file_id+'"> <a htef="#null" onclick="remove_this_file(\''+file_id+'\',\''+this.files[i].name+'\');"> <img border="0" src="../../static/convert_docx/file_icons/ico_cancel.png" width="16" height="15"> </div> </div>';
				}
			}
			$(".file_boxes").html("");
			$("#removed_files").html("");
